<template><div><h1 id="算法灵神题单" tabindex="-1"><a class="header-anchor" href="#算法灵神题单"><span>算法灵神题单</span></a></h1>
<p><a href="https://leetcode.cn/circle/discuss/RvFUtj/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/circle/discuss/RvFUtj/</a></p>
<h2 id="滑动窗口与双指针-定长-不定长-至多-至少-恰好-单序列-双序列-三指针" tabindex="-1"><a class="header-anchor" href="#滑动窗口与双指针-定长-不定长-至多-至少-恰好-单序列-双序列-三指针"><span>滑动窗口与双指针（定长/不定长/至多/至少/恰好/单序列/双序列/三指针）</span></a></h2>
<h3 id="定长滑动窗口" tabindex="-1"><a class="header-anchor" href="#定长滑动窗口"><span>定长滑动窗口</span></a></h3>
<h4 id="_643-子数组最大平均数-i" tabindex="-1"><a class="header-anchor" href="#_643-子数组最大平均数-i"><span>643. 子数组最大平均数 I</span></a></h4>
<p><a href="https://leetcode.cn/problems/maximum-average-subarray-i/description/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/maximum-average-subarray-i/description/</a></p>
<p>1.不要预设数字是正数，比如下面这个max不能设置为0<br>
2.在第一次滑动窗口长度符合条件的时候，虽然不用进行判定，但是要设置值</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1343-大小为-k-且平均值大于等于阈值的子数组数目" tabindex="-1"><a class="header-anchor" href="#_1343-大小为-k-且平均值大于等于阈值的子数组数目"><span>1343. 大小为 K 且平均值大于等于阈值的子数组数目</span></a></h4>
<p><a href="https://leetcode.cn/problems/number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold/description/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold/description/</a></p>
<p>做判断的时候，不是=，而是===(经常犯错，但如果是编辑器的话是会纠错的)</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token doc-comment comment">/**</span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="不定长滑动窗口" tabindex="-1"><a class="header-anchor" href="#不定长滑动窗口"><span>不定长滑动窗口</span></a></h3>
<h3 id="单序列双指针" tabindex="-1"><a class="header-anchor" href="#单序列双指针"><span>单序列双指针</span></a></h3>
<h3 id="双序列双指针" tabindex="-1"><a class="header-anchor" href="#双序列双指针"><span>双序列双指针</span></a></h3>
<h3 id="三指针" tabindex="-1"><a class="header-anchor" href="#三指针"><span>三指针</span></a></h3>
<h2 id="链表、二叉树与一般树-前后指针-快慢指针-dfs-bfs-直径-lca" tabindex="-1"><a class="header-anchor" href="#链表、二叉树与一般树-前后指针-快慢指针-dfs-bfs-直径-lca"><span>链表、二叉树与一般树（前后指针/快慢指针/DFS/BFS/直径/LCA）</span></a></h2>
<h3 id="一、链表" tabindex="-1"><a class="header-anchor" href="#一、链表"><span>一、链表</span></a></h3>
<h3 id="二、二叉树" tabindex="-1"><a class="header-anchor" href="#二、二叉树"><span>二、二叉树</span></a></h3>
<blockquote>
<p>学习递归，从二叉树开始。
晕递归的同学，请先看视频讲解【基础算法精讲 09】，欢迎点赞~
带着问题去做下面的题目：</p>
<ol>
<li>一般来说，DFS 的递归边界是空节点。在什么情况下，要额外把叶子节点作为递归边界？</li>
<li>在什么情况下，DFS 需要有返回值？什么情况下不需要有返回值？</li>
<li>在什么情况下，题目更适合用自顶向下的方法解决？什么情况下更适合用自底向上的方法解决？</li>
</ol>
</blockquote>
<h4 id="§2-1-遍历二叉树" tabindex="-1"><a class="header-anchor" href="#§2-1-遍历二叉树"><span>§2.1 遍历二叉树</span></a></h4>
<h5 id="_144-二叉树的前序遍历" tabindex="-1"><a class="header-anchor" href="#_144-二叉树的前序遍历"><span>144. 二叉树的前序遍历</span></a></h5>
<p><a href="https://leetcode.cn/problems/binary-tree-preorder-traversal/description/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/binary-tree-preorder-traversal/description/</a></p>
<p>递归法<br>
这里不能return func(root.left)，一旦return就直接跳出func了（当使用递归的时候想清楚小问题，大问题是什么，这样才不会弄错）</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token doc-comment comment">/**</span>
...
<p><a href="https://leetcode.cn/problems/binary-tree-inorder-traversal/submissions/571418917/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/binary-tree-inorder-traversal/submissions/571418917/</a></p>
<p>递归法<br>
递归法实质上就是隐形地维护了一个栈</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token doc-comment comment">/**</span>
<span class="line"> * Definition for a binary tree node.</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>迭代法</p>
<ol>
<li>迭代法实质上就是把隐形维护的栈显化出来了</li>
<li>因为我们是不会修改二叉树的结构和值的，所以循环的时候，不是一步步循环的。我们不能想着每次while循环k就只移动一下，来设置循环，这样是不行的</li>
</ol>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token doc-comment comment">/**</span>
<span class="line"> * Definition for a binary tree node.</span>
<span class="line"> * function TreeNode(val, left, right) <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_872-叶子相似的树" tabindex="-1"><a class="header-anchor" href="#_872-叶子相似的树"><span>872. 叶子相似的树</span></a></h5>
<p><a href="https://leetcode.cn/problems/leaf-similar-trees/description/" target="_blank" rel="noopener noreferrer">https://leetcode.cn/problems/leaf-similar-trees/description/</a></p>
<ol>
<li>不能使用arr1.join('')===arr2.join('')这样的判断方式，否则[1,2]和[12]会相等，对于数组可以使用toString的方式，比如[1,2,3]用toString方法转换后变成了&quot;1,2,3&quot;</li>
</ol>
<blockquote>
<p>拓展</p>
</blockquote>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token doc-comment comment">/**</span>
<span class="line"> * Definition for a binary tree node.</span>
<span class="line"> * function TreeNode(val, left, right) <span class="token punctuation">{</span></span>
<span class="line"> *     this.val = (val===undefined ? 0 : val)</span>
<span class="line"> *     this.left = (left===undefined ? null : left)</span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="lcp-44-开幕式焰火" tabindex="-1"><a class="header-anchor" href="#lcp-44-开幕式焰火"><span>LCP 44. 开幕式焰火</span></a></h5>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js" data-title="js"><pre v-pre><code><span class="line"><span class="token doc-comment comment">/**</span>
<span class="line"> * Definition for a binary tree node.</span>
...
<span class="line"><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="三、一般树" tabindex="-1"><a class="header-anchor" href="#三、一般树"><span>三、一般树</span></a></h3>
</div></template>
